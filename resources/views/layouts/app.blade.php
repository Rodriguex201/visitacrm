            ...
            >
                <div class="flex items-start justify-between border-b border-slate-200 px-5 py-5" :class="sidebarCollapsed ? 'md:px-3' : ''">
                    <div x-show="shouldShowLabels()" x-transition class="md:block">
                        @if ($sidebarLogoUrl)
                            <div class="flex h-12 w-full max-w-[220px] items-center justify-start overflow-hidden rounded-lg">
                                <img src="{{ $sidebarLogoUrl }}" alt="Logo principal" class="h-full w-full object-contain object-left">
                            </div>
                        @endif
                        <p class="{{ $sidebarLogoUrl ? 'mt-3 text-lg' : 'text-3xl' }} font-bold leading-none text-slate-950">{{ $sidebarLogoUrl ? 'VisitaCRM' : $sidebarBrandTitle }}</p>
            ...
            <main class="min-h-screen flex-1 pb-6">
                <div class="mx-auto flex w-full max-w-[1300px] items-center justify-between px-4 py-4 md:hidden">
                    ...
                    <div class="flex min-w-0 items-center gap-3">
                        @if ($sidebarLogoUrl)
                            <div class="flex h-10 w-28 items-center overflow-hidden rounded-md">
                                <img src="{{ $sidebarLogoUrl }}" alt="Logo principal" class="h-full w-full object-contain object-left">
                            </div>
                        @endif
