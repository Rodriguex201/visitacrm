...
@section('content')
    <section x-data="{ ...createNuevaVisitaModalState(), init() { this.initNuevaVisitaModal() } }" class="space-y-5">
        <div class="flex items-start justify-between gap-3">
            ...
            <button type="button" @click="openNuevaVisitaModal()" class="hidden items-center gap-2 rounded-lg bg-blue-600 px-4 py-2.5 text-xs font-semibold text-white shadow-sm transition hover:bg-blue-700 md:inline-flex">
            ...
            <button type="button" @click="openNuevaVisitaModal()" class="inline-flex h-9 w-9 items-center justify-center rounded-xl bg-blue-600 text-lg font-semibold text-white shadow-sm transition hover:bg-blue-700 md:hidden">+</button>
        </div>
